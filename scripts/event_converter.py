...
SPORTS_LIST = [
    ...
    ('lmb_lmp', '05. LMB LMP', 'https://raw.githubusercontent.com/jsosao/bics/main/picons/mx_beisbol_lmp[.]png', [
...
CUSTOM_FILTERS = {
    ...
    'alfa_eventos': lambda group, title: "(eventos)" in group.lower() and not any(excluido in group.lower() for excluido in ["nba (eventos)", "nfl (eventos)", "lmb y lmp (eventos)"]),
    ...
    'alfa_bein': lambda group, title: "bein sport" in title.lower(),        
