...
CUSTOM_FILTERS = {
    ...
    'alfa_nba': lambda group, title: any(x in group.lower() for x in ["nba", "eventos"]),
    'alfa_nfl': lambda group, title: "nfl (eventos)" in title.lower(),  
    'alfa_nhl': lambda group, title: "nhl (eventos)" in title.lower(), 
    'alfa_mlb': lambda group, title: "mlb (eventos)" in title.lower(),     
